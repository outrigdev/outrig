	...
	tests := []struct {
		...
		},
		{
			...
			expected: []Token{
				...
				{Type: TokenWord, Value: ":", Position: Position{Start: 10, End: 11}},
		...
		},
		{
			...
			expected: []Token{
				{Type: "$", Value: "$", Position: Position{Start: 0, End: 1}},
				{Type: TokenWord, Value: "field:value", Position: Position{Start: 1, End: 12}},
				{Type: TokenEOF, Value: "", Position: Position{Start: 12, End: 12}},
			},
		},
		{
			...
			expected: []Token{
				...
				{Type: TokenWhitespace, Value: " ", Position: Position{Start: 7, End: 8}},
				{Type: TokenWord, Value: ":", Position: Position{Start: 8, End: 9}},
				{Type: TokenWhitespace, Value: " ", Position: Position{Start: 9, End: 10}},
