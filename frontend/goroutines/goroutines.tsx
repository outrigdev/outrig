...
import { getDefaultStore, PrimitiveAtom, useAtom, useAtomValue } from "jotai";
import { Layers, Layers2, Search, SkipForward } from "lucide-react";
import React, { useCallback, useEffect, useRef, useState } from "react";
import { Tag } from "../elements/tag";
import { GoRoutinesModel } from "./goroutines-model";
import { StackTrace } from "./stacktrace";

// TimeSlider component for selecting timestamp
interface TimeSliderProps {
    model: GoRoutinesModel;
}

const TimeSlider: React.FC<TimeSliderProps> = ({ model }) => {
                ...
                <div className="px-4 py-2 border-b border-border">
                    <div className="flex items-center gap-4 text-xs text-secondary">
                        <span className="whitespace-nowrap">
                            ...
                            {Math.floor((lastSearchTimestamp - model.getTimeRange().startTime) / 1000)}s) (
